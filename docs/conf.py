...
project = "CanarieAPI"
copyright = "2017, CRIM"  # noqa  # pylint: disable=W0622,redefined-builtin
...
htmlhelp_basename = "canarieapidoc"
...
authors = [_author.strip() for _author in __meta__.__author__.split(",")]
man_pages = [
    ("index", "canarieapi",
     u"CanarieAPI Documentation",
     authors, 1)
]
